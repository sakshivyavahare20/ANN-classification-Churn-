...
# Create DataFrame for Geography and apply one-hot encoding
geo_df = pd.DataFrame({'Geography': [geography]})
geo_encoded = onehot_encoder_geo.transform(geo_df).toarray()

# ✅ Manually create column names (works in all versions)
...
# Combine input features with encoded geography
